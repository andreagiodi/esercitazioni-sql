...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=112494&schain=1.0,1!snack-media.com,SNM_2979,1&cbuster=1666949325',
					origQString: 's=112494&schain=1.0,1!snack-media.com,SNM_2979,1',
					placementId: 112494,
					x: 640,
					y: 440,
					videoType: 'flow',
					...
					customTargetingProperties: {"objectType":"window.top","objectFunction":"gms.config"},
